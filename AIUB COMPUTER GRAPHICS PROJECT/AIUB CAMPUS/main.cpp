...
void turjoCar(int value)
{
    ...
    glutTimerFunc(100, turjoCar, 0);
}

void circlecarturjo(float x, float y, float radius)
{
	int triangleAmount = 100; //# of triangles used to draw circle
...
void turjo_vehicle1()
{
   glPushMatrix();
    ...
    circlecarturjo(0.07,-0.938,0.035);
    circlecarturjo(0.2,-0.938,0.035);
...
void turjoupdate(int value) {
	...
	glutTimerFunc(100, turjoupdate, 0);

}

void turjoupdate_3(int value) {
...
void turjoupdate_2(int value) {
	...
	glutTimerFunc(100, turjoupdate_2, 0);

}


	void turjoupdate1(int value) {
	...
	glutTimerFunc(100, turjoupdate1, 0);
}

void turjoupdateCar(int value)
{
    if(carPosition6 < - 1.5)
    {
        carPosition6 = 1.2f;
    ...
    glutTimerFunc(10, turjoupdateCar, 0);
}
...
void turjocirclecar(float x, float y, float radius)
{
	int triangleAmount = 100; //# of triangles used to draw circle
...
void turjovehicle2()
{
   glPushMatrix();
    ...
    //wheels
    glColor3f(0.913,0,0);
    turjocirclecar(0.07,-0.938,0.035);
    turjocirclecar(0.2,-0.938,0.035);
    //
    glColor3f(0,0,0);
    glLineWidth(1.1);
    glBegin(GL_LINES);
...
void init(void)
{
    ...
    //C
        glutTimerFunc(100, turjoupdate, 0);
        glutTimerFunc(100, turjoupdate_3, 0);
        glutTimerFunc(100, turjoupdate_2, 0);
        glutTimerFunc(100, turjoupdate1, 0);
        glutTimerFunc(100, turjoupdateCar, 0);
